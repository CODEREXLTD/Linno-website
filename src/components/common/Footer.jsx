...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[radial-gradient(121.21%_104.42%_at_-7.03%_-6.12%,rgba(255,255,255,0.12)_13.46%,rgba(128,163,238,0.12)_36.79%,rgba(112,189,234,0.12)_64.06%,rgba(33,240,168,0.12)_100%)]
 mt-auto">
