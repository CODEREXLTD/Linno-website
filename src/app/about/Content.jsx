    ...
    <div className="w-full bg-[#ffffff]">
      ...
      <section className="w-full bg-[#090936] py-[50px] md:py-[120px]">
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative z-10 flex justify-center items-start w-[48%] mx-auto mb-[36px] sm:mb-[54px] lg:mb-[72px]">
              <div className="flex flex-col gap-[2px] sm:gap-[3px] lg:gap-[4px] items-center">
                ...
                <p className="text-[15px] sm:text-[18px] lg:text-[20px] font-inter font-normal leading-[23px] sm:leading-[27px] lg:leading-[30px] text-center text-white w-full">
                  At Linno, we offer a comprehensive benefits package to support our employees'
          ...
          <div className="w-full relative z-20">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[20px] sm:gap-[30px] w-full">
              {benefits?.map((benefit, index) => (
                <div
                  key={index}
                  className="flex flex-col sm:flex-row lg:flex-row justify-start items-center sm:items-start lg:items-center gap-[10px] sm:gap-[15px] lg:gap-[20px] w-full group hover:scale-105 transition-transform duration-200 glass"
                >
      ...
      <section className="w-full py-[50px] sm:py-[75px] lg:py-[100px] px-4 sm:px-6 lg:px-8 bg-[#fbfbff]">
        <div className="w-full max-w-[1440px] mx-auto">
          <div className="">
            <h2 className="text-[#0B0B35] font-sora text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal leading-tight">
              Meet Our <span className="font-bold  ">Teams</span>
            </h2>
            <p class="max-w-[720px] w-full mt-2 sm:mt-3 md:mt-4 lg:mt-6 mb-8 sm:mb-10 md:mb-12 lg:mb-16 text-[#40403F] font-inter text-base sm:text-lg md:text-xl lg:text-2xl font-normal leading-[29px]">
            ...
            <div className="w-full md:w-1/3 md:sticky top-20 self-start">
              <div className="space-y-4 sm:space-y-6 lg:space-y-8 mt-0 md:mt-4 lg:mt-10">
                {departments?.map((dept, index) => (
                  ...
                  >
                    <div
                      className={`w-[16px] sm:w-[18px] lg:w-[20px] h-[1px] transition-colors duration-200 ${
                        dept?.active ? 'bg-[#3433fe]' : 'bg-[#0f0e55] group-hover:bg-[#3433fe]'
                      }`}
                    ></div>
                    <span
                      className={`text-[16px] sm:text-[18px] lg:text-[20px] font-bold font-sans leading-[20px] sm:leading-[22px] lg:leading-[24px] transition-colors duration-200 ${
                        dept?.active
                          ? 'text-[#3433fe]'
