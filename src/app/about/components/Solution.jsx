                    ...
                    <div className="solution-wrapper">
                        <div className="single-solution">
                            ...
                            <Link href={'https://rextheme.com/wpvr/'} target='_blank' className="solution-link">
                                View Solutions
                                <svg width="14" height="15" fill="none" viewBox="0 0 14 15" xmlns="http://www.w3.org/2000/svg"><path stroke="#585A65" stroke-linecap="round" strokeLinejoin="round" stroke-miterlimit="10" stroke-width="1.476" d="M13.144 1.467L1.338 13.273M13.144 1.467v8.66m0-8.66h-8.66"/></svg>
                            </Link>
                        </div>
