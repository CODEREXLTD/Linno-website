                  ...
                  <div className="flex flex-col gap-[36px]">
                    {tableOfContents?.map((item, index) => (
                      ...
                      >
                        ...
                        <span
                          className={`text-[18px] sm:text-[20px] font-sora font-normal leading-[22px] sm:leading-[24px] transition-colors ${
              ...
              <div className="flex-1">
                ...
                <div className="max-w-[52%] ml-auto">
                  <div className="text-[16px] sm:text-[20px] font-sora font-medium leading-[24px] sm:leading-[30px] text-[#787878]">
                    <p className="mb-6">
                      WordPress is a powerful CMS, used to build over 27% of all websites on the
                      internet. It offers over 3000 free themes and over 8000 premium themes, that
                      are GPL licensed, for developing websites.
                    </p>
                    <p className="mb-6">
                      While creating a website, you may choose to among brilliant themes. However,
                      you should get familiar with how to create a child theme.
                    </p>
                    <p className="mb-6">Let me explain why.</p>
                    <p className="mb-6">
                      All WordPress themes release updates every now and then to fix bugs and add
                      new features. This is good in the sense that your theme is getting more and
                      more secure with fewer bugs and good new features.
                    </p>
                    <p className="mb-6">
                      However, if you have made any customization to the theme, then you will face
                      issues.
                    </p>
                    <p className="mb-6">
                      Basically, when updating a theme, all the core files of the theme are replaced
                      with new updated files.
                    </p>
                    <p className="mb-6">
                      Hence your theme will lose all the customizations that you implemented. Also,
                      there is no way to get them back (
                      <span className="underline">unless you kept backup</span>) once updated.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-[16px]">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-8">
                  {locations?.map((location, index) => (
                    <p
                      key={index}
                      className="text-[14px] sm:text-[16px] font-sora font-medium leading-[22px] sm:leading-[27px] text-[#51515f] text-center flex-1"
                    >
                      {location?.address}
                    </p>
                  ))}
