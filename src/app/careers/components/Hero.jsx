    ...
    return (
        <>
            <section className="linno-career-hero">
                ...
                <svg className='hero-bottom-shape' width="486" height="1259" fill="none" viewBox="0 0 486 1259" xmlns="http://www.w3.org/2000/svg"><g filter="url(#filter0_f_6116_232)"><path fill="url(#paint0_radial_6116_232)" fillOpacity=".2" d="M912.417 892.209c122.713-357.905-4.87-725.901-284.975-821.943-280.104-96.042-132.35 61.329-255.068 419.234-122.717 357.904-509.5 465-62 589 280.105 96.04 479.325 171.61 602.043-186.291z"/></g><defs><radialGradient id="paint0_radial_6116_232" cx="0" cy="0" r="1" gradientTransform="matrix(-574.244 -162.981 -248.115 809.648 584.771 776.145)" gradientUnits="userSpaceOnUse"><stop stopColor="#3433FE"/><stop offset="1" stopColor="#fff" stopOpacity="0"/></radialGradient><filter id="filter0_f_6116_232" width="1059.1" height="1315.62" x="0" y="-57.404" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse"><feFlood floodOpacity="0" result="BackgroundImageFix"/><feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"/><feGaussianBlur result="effect1_foregroundBlur_6116_232" stdDeviation="50"/></filter></defs></svg>
            </section>
